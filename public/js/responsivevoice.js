	...
	this.speak = function(text, voicename) {
		...
		for (var i=0; i<multipartText.length; i++) {
			...
			if (!fallbackMode) {
				...
				var url = 'https://www.corsproxy.com/translate.google.com/translate_tts?ie=UTF-8&q=' + multipartText[i] + '&tl=' + profile.collectionvoice.lang || profile.systemvoice.lang || 'en-US';
